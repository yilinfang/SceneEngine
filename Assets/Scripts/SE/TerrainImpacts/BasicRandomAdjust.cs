...
namespace SE.TerrainImpacts {
	public class BasicRandomAdjust : TerrainUnitData.Impact {
        ...
        public override void Main(TerrainUnitData Data) {
            ...
            map[1] += (long)(Data.Seed[1].NextRandomNum(RandomRange) - t);
			map[3] += (long)(Data.Seed[2].NextRandomNum(RandomRange) - t);
			map[4] += (long)(Data.Seed[0].NextRandomNum(RandomRange) - t);
			map[5] += (long)(Data.Seed[3].NextRandomNum(RandomRange) - t);
			map[7] += (long)(Data.Seed[4].NextRandomNum(RandomRange) - t);
        }
	}
}
