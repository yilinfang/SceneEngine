...
namespace SE.TerrainImpacts {
	public class BasicRandomAdjust : TerrainUnitData.Impact {
        ...
        public override void Main(ref TerrainUnitData Data) {
            ...
            basemap[1] += (long)Data.Seed[1].NextRandomNum(RandomRange) - (long)t;
            basemap[3] += (long)Data.Seed[2].NextRandomNum(RandomRange) - (long)t;
            basemap[4] += (long)Data.Seed[0].NextRandomNum(RandomRange) - (long)t;
            basemap[5] += (long)Data.Seed[3].NextRandomNum(RandomRange) - (long)t;
            basemap[7] += (long)Data.Seed[4].NextRandomNum(RandomRange) - (long)t;
        }
	}
}
